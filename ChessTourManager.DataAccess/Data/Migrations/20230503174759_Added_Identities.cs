...
{
    /// <inheritdoc />
    public partial class Added_Identities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("role_claims_pk", x => x.role_claim_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("user_claims_pk", x => x.user_claim_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("user_logins_pk", x => new { x.login_provider, x.provider_key });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("user_tokens_pk", x => new { x.user_id, x.login_provider, x.name });
                });

            migrationBuilder.CreateIndex(
                name: "role_claims_role_id_idx",
                table: "role_claims",
                column: "role_id");
