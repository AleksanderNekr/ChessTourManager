...
public class CompleteChangePasswordCommand : CommandBase
{
    ...
    public override void Execute(object? parameter)
    {
        ...
        if (!PasswordHasher.VerifyPassword(_changePasswordViewModel.CurrentPassword,
                                           LoginViewModel.CurrentUser.PassHash))
        {
        ...
        if (_changePasswordViewModel.NewPassword != _changePasswordViewModel.RepeatPassword)
        {
        ...
        bool isNewEmpty    = _changePasswordViewModel.NewPassword.Length    == 0;
        bool isRepeatEmpty = _changePasswordViewModel.RepeatPassword.Length == 0;
        ...
        LoginViewModel.CurrentUser.PassHash = PasswordHasher.HashPassword(_changePasswordViewModel.NewPassword);
