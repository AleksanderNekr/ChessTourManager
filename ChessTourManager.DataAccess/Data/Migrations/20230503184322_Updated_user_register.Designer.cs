...
namespace ChessTourManager.DataAccess.Data.Migrations
{
    ...
    [Migration("20230503184322_Updated_user_register")]
    partial class Updated_user_register
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChessTourManager.DataAccess.Entities.Kind", b =>
                {
                    ...
                    b.HasIndex(new[] { "KindName" }, "kinds_name_uq")
                        .IsUnique();
            ...
            modelBuilder.Entity("ChessTourManager.DataAccess.Entities.Player", b =>
                {
                    ...
                    b.HasKey("PlayerId", "TournamentId", "OrganizerId")
                        .HasName("players_pk");
                    ...
                    b.HasIndex(new[] { "PlayerId", "TournamentId", "PlayerLastName", "PlayerFirstName", "PlayerAttribute" }, "players_name_attr_uq")
                        .IsUnique();
            ...
            modelBuilder.Entity("ChessTourManager.DataAccess.Entities.System", b =>
                {
                    ...
                    b.HasIndex(new[] { "SystemName" }, "systems_name_uq")
                        .IsUnique();
            ...
            modelBuilder.Entity("ChessTourManager.DataAccess.Entities.Tournament", b =>
                {
                    ...
                    b.HasKey("TournamentId", "OrganizerId")
                    ...
                    b.HasIndex(new[] { "TournamentId", "OrganizerId", "TournamentName" }, "tournaments_name_uq")
                        .IsUnique();
