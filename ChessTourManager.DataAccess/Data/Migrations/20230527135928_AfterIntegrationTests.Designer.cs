...
namespace ChessTourManager.DataAccess.Data.Migrations
{
    ...
    [Migration("20230527135928_AfterIntegrationTests")]
    partial class AfterIntegrationTests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChessTourManager.DataAccess.Entities.Team", b =>
                {
                    ...
                    b.HasKey("Id", "OrganizerId", "TournamentId")
                        .HasName("teams_pk");

                    b.HasIndex("TournamentId", "OrganizerId");

                    b.HasIndex(new[] { "Id", "TournamentId", "TeamName" }, "teams_name_uq")
                        .IsUnique();
            ...
            modelBuilder.Entity("ChessTourManager.DataAccess.Entities.Player", b =>
                {
                    b.Navigation("GamesBlackOpponents");

                    b.Navigation("GamesWhiteOpponents");
                });
